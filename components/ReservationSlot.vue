...
<style scoped>.slot { width: 100%; min-height: 2.75rem; border: 1px solid color-mix(in srgb, var(--color-primary) 30%, white); border-radius: .45rem; padding: .25rem .2rem; background: var(--color-slot-available); color: var(--color-primary-dark); font-size: .82rem; font-weight: 700; white-space: nowrap; }.slot.expired { border-color: var(--color-slot-expired); background: var(--color-slot-expired); color: var(--color-text-primary); }.slot.occupied { border-color: var(--color-slot-occupied); background: var(--color-slot-occupied); color: #fff; }.slot.mine { border-color: var(--color-slot-mine); background: var(--color-slot-mine); color: #fff; }.slot:disabled { cursor: not-allowed; }</style>
