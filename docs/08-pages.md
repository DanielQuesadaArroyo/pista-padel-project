...
muestra una leyenda compacta. Los slots usan `min-height: 2.2rem`
(aproximadamente 35 px), conservan el texto legible y no permiten saltos de línea en el horario.
